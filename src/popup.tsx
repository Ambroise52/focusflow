...
import Header          from "./popup-ui/components/Header";
import ActiveSession   from "./popup-ui/components/ActiveSession";
import WorkspaceLibrary from "./popup-ui/components/WorkspaceLibrary";
import PaywallModal    from "./popup-ui/components/PaywallModal";

import { getSettings }   from "./lib/storage";
import { isPremiumUser } from "./lib/supabase";

import "./popup-ui/style.css"; // Tailwind base styles
...
const NAV_TABS: {
  ...
  { id: "session", label: "Active",     Icon: BookOpen   },
